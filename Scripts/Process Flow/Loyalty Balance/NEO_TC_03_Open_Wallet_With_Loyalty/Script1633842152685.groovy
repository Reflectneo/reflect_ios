...
def TotalLoyaltyBalance = Mobile.getText(findTestObject('Loyalty Balance/DashBoard/IOS.widget.TextView - LoyaltyBalance'), 
    10)
...
def LoyaltyBalanceHistory = Mobile.getText(findTestObject('Loyalty Balance/LoyaltyHistory/IOS.widget.TextView - LoyaltyBalanceHistory'), 
    10)
...
Mobile.tap(findTestObject('Saving Space/Custom/IOS.widget.Button-Back'), 10)
