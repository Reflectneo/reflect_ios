...
'Click on Cancel'
Mobile.tap(findTestObject('Top Up/Card Top-up/android.widget.Button - Cancel For Mobicash'), 0)

Mobile.delay(2)

'Verify Redirect to amount Screen'
Mobile.verifyElementExist(findTestObject('Top Up/Card Top-up/android.widget.EditText - Top-up Amount'), 10)
