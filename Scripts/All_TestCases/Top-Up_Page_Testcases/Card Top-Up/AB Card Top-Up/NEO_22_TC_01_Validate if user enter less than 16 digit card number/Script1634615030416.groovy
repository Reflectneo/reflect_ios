...
'Enter Card Number'
Mobile.setText(findTestObject('Top Up/Card Top-up/android.widget.EditText - Card Number_AB'), '44752200', 0)

'Take ScreenShot'
Mobile.takeScreenshot()

'Verify Submit Button Disabled'
Mobile.verifyElementExist(findTestObject('Top Up/Card Top-up/android.widget.Button - Submit_Disabled'), 10)
