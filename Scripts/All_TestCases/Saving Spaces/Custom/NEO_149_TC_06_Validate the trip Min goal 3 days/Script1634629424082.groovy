...
Mobile.tap(findTestObject('Saving Space/Car/IOS.widget.ImageButton -Car-date'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.setText(findTestObject('Saving Space/Trip/Setup your saving space/IOS.widget.EditText - 2021'), '2021', 0)
...
Mobile.verifyElementExist(findTestObject('Saving Space/Trip/Setup your saving space/IOS.widget.TextView - The goal cannot be less than 3 days'), 
    0)
