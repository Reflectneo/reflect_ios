...
Mobile.verifyElementExist(findTestObject('Saving Space/Trip/Setup your saving space/IOS.widget.Button - Next_Disabled'), 
    10)
...
Mobile.setText(findTestObject('Saving Space/Trip/Setup your saving space/IOS.widget.EditText - Sep'), 'Nov', 0)
