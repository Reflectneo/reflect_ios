...
Mobile.tap(findTestObject('User_Registration/Registration_Screen/MyInformation/android.widget.EditText - First Name'), 60)

Mobile.clearText(findTestObject('User_Registration/Registration_Screen/MyInformation/android.widget.EditText - First Name'), 
    0)
...
CustomKeywords.'com.arabbank.toastmessage.InvalidMessage.ValidationMessage'('Please enter your name', GlobalVariable.OutputFile)
