...
'Verify  Error message "Confirm Password Should be 8 digit and more".'
...
'Confirm password should be 8 digits or mor'
CustomKeywords.'com.arabbank.toastmessage.InvalidMessage.ValidationMessage'('Confirm password should be 8 digits', GlobalVariable.OutputFile)
