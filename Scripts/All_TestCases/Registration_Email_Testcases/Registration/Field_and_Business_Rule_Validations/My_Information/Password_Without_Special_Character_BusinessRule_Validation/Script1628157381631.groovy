...
'Verify  Error message "Then Password should inlcude at least one number and special character ".'
Mobile.delay(2)
...
CustomKeywords.'com.arabbank.toastmessage.InvalidMessage.ValidationMessage'('Password should include at least', GlobalVariable.OutputFile)
