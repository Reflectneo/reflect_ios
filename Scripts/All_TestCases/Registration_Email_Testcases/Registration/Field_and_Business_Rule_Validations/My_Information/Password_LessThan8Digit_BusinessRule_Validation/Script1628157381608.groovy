...
'Verify  Error message "Password Should be 8 digit and more".'
Mobile.delay(2)
...
CustomKeywords.'com.arabbank.toastmessage.InvalidMessage.ValidationMessage'('Password should be 8 digits or more', GlobalVariable.OutputFile)
