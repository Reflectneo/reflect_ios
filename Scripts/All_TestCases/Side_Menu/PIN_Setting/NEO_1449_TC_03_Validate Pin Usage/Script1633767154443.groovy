...
'Click on View Card'
Mobile.tap(findTestObject('Card Dashboard/IOS.widget.Button - View'), 0)
...
Mobile.verifyElementExist(findTestObject('Card Dashboard/Card Settings/Card Details/IOS.widget.TextView - Card Number'),
	10)

'Verify CVC'
Mobile.verifyElementExist(findTestObject('Card Dashboard/Card Settings/Card Details/IOS.widget.TextView - CVC'), 10)

'Verify Expiry Date'
Mobile.verifyElementExist(findTestObject('Card Dashboard/Card Settings/Card Details/IOS.widget.TextView - Expiry Date'),
	10)
