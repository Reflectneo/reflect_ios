...
Mobile.setText(findTestObject('User_Login/IOS.widget.EditText - Email address'), '', 0)

'Enter Password on Password Fields'
Mobile.setText(findTestObject('User_Login/IOS.widget.EditText - Password'), 'Aa@123456', 0)
