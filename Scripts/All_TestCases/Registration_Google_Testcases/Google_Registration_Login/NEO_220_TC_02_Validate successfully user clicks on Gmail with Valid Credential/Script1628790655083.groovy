...
WebUI.callTestCase(findTestCase('Common/Login_Google_Application'), [:], FailureHandling.CONTINUE_ON_FAILURE)

'Verify  successfully user clicks on Gmail with Valid Credential'
