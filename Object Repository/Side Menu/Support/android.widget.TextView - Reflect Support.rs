...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Reflect Support</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Reflect Support' or . = 'Reflect Support') and @resource-id = 'single-subtitle']</locator>
