...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Reject' or . = 'Reject') and @resource-id = 'com.arabbank.neobank:id/negativeButton']</locator>
