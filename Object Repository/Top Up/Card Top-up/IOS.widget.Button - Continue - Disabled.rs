...
<MobileElementEntity>
   ...
   <name>android.widget.Button - Continue - Disabled</name>
   <tag></tag>
   <elementGuidId>1cefc429-d3fc-49b9-891a-d8ba347a7b06</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Continue' or . = 'Continue') and @enabled = 'false']</locator>
