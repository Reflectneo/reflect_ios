...
<MobileElementEntity>
   ...
   <name>android.widget.Button - Submit_Disabled</name>
   <tag></tag>
   <elementGuidId>9d789d20-cbfb-41a5-aa62-619175f3406e</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Submit' or . = 'Submit') and @resource-id = 'com.arabbank.neobank:id/submit' and @enabled = 'false']</locator>
