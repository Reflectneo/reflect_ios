...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Swift code</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Swift code' or . = 'Swift code')]</locator>
