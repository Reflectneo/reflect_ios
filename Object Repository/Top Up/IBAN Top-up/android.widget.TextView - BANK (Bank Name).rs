...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - BANK (Bank Name)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'BANK (Bank Name)' or . = 'BANK (Bank Name)')]</locator>
