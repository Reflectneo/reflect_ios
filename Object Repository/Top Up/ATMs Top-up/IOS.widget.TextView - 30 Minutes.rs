...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - 30 Minutes</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '30 Minutes' or . = '30 Minutes') and @resource-id = 'com.arabbank.neobank:id/expTime']</locator>
