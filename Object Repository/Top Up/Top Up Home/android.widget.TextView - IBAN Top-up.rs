...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - IBAN Top-up</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'IBAN Top-up' or . = 'IBAN Top-up') and @resource-id = 'com.arabbank.neobank:id/type']</locator>
