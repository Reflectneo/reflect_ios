...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Card Top-up</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Card Top-up' or . = 'Card Top-up') and @resource-id = 'com.arabbank.neobank:id/type']</locator>
