...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - ATM Deposit</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'ATM Deposit' or . = 'ATM Deposit') and @resource-id = 'com.arabbank.neobank:id/type']</locator>
