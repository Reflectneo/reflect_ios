...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Loyalty Balance</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Loyalty Balance' or . = 'Loyalty Balance')]</locator>
