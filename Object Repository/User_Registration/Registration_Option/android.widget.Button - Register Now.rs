...
<MobileElementEntity>
   ...
   <name>android.widget.Button - Register Now</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Register Now' or . = 'Register Now') and @resource-id = 'com.arabbank.neobank:id/contWitEmail']</locator>
