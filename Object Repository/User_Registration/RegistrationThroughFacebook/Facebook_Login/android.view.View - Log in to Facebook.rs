...
<MobileElementEntity>
   ...
   <name>android.view.View - Log in to Facebook</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.view.View' and (@text = 'Log in to Facebook' or . = 'Log in to Facebook')]</locator>
