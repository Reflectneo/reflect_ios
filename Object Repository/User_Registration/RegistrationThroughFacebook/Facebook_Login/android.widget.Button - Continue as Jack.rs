...
<MobileElementEntity>
   ...
   <name>android.widget.Button - Continue as Jack</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Continue as Jack' or . = 'Continue as Jack')]</locator>
