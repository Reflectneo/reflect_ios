...
<MobileElementEntity>
   ...
   <tag></tag>
   <elementGuidId>d3c93acf-9e52-4e66-8102-5f0975959ce9</elementGuidId>
   ...
   <locator>//*[(@text = 'Log In' or . = 'Log In') and @resource-id = 'loginbutton']</locator>
