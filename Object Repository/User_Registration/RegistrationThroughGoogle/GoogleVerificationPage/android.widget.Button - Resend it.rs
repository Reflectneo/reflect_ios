...
<MobileElementEntity>
   ...
   <name>android.widget.Button - Resend it</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Resend it' or . = 'Resend it') and @resource-id = 'HmIokf']</locator>
