...
<MobileElementEntity>
   ...
   <name>android.widget.Button - Enter your password</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Enter your password' or . = 'Enter your password')]</locator>
