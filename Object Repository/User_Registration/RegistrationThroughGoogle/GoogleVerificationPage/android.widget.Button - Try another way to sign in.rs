...
<MobileElementEntity>
   ...
   <name>android.widget.Button - Try another way to sign in</name>
   <tag></tag>
   ...
   <webElementProperties>
      ...
      <name>text</name>
      <type>Main</type>
      <value>Try another way to sign in</value>
   </webElementProperties>
   <webElementProperties>
      <isSelected>true</isSelected>
      <matchCondition>equals</matchCondition>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Try another way to sign in' or . = 'Try another way to sign in') and @resource-id = 'skipChallenge']</locator>
