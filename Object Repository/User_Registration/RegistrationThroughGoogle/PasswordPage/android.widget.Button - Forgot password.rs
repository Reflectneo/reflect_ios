...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Forgot password?' or . = 'Forgot password?') and @resource-id = 'needHelp']</locator>
