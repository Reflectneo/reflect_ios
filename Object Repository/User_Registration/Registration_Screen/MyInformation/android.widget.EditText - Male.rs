...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Male</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Male' or . = 'Male') and @resource-id = 'com.arabbank.neobank:id/gender']</locator>
