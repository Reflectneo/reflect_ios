...
<MobileElementEntity>
   ...
   <name>IOS.widget.Button - Select</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Select' or . = 'Select') and @resource-id = 'com.arabbank.neobank:id/select']</locator>
