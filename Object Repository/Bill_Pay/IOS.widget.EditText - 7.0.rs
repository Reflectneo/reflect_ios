...
<MobileElementEntity>
   ...
   <name>IOS.widget.EditText - 7.0</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = '7.0' or . = '7.0') and @resource-id = 'com.arabbank.neobank:id/amountValue']</locator>
