...
<MobileElementEntity>
   ...
   <name>IOS.widget.TextView - Fee amount</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Fee amount' or . = 'Fee amount') and @resource-id = 'com.arabbank.neobank:id/key']</locator>
