...
<MobileElementEntity>
   ...
   <name>IOS.widget.TextView - Reference number</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Reference number' or . = 'Reference number') and @resource-id = 'com.arabbank.neobank:id/key']</locator>
